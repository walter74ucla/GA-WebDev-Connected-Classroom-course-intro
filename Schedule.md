...
* Lesson 2 -  [ajax](https://git.generalassemb.ly/WebDev-Connected-Classroom/react-ajax-crimes/blob/master/README.md)
* HW  - [ajax lab/hw](https://git.generalassemb.ly/WebDev-Connected-Classroom/React-ajax-lab-hw/blob/master/README.md)

#### __Tuesday__ - Ajax, EarthQuake lab
...
*hw [giphy search](https://git.generalassemb.ly/WebDev-Connected-Classroom/giphy-react-search-hw)

#### __Wednesday__ Build Todo With Express API

* Long Lesson - [Create A todo App](https://git.generalassemb.ly/JimHaff/react-todo/blob/master/README.md)


#### __Thursday__ React Router, Start Projects
...
### __Thursday__ - Express API

* Lesson 1 - [express API](https://git.generalassemb.ly/WebDev-Connected-Classroom/express-fruits-api/blob/master/README.md)
* Lab 1 - [api lab](https://git.generalassemb.ly/WebDev-Connected-Classroom/create-api-lab/blob/master/README.md)
* Lesson 2 -  [Testing Mocha & Chai](https://git.generalassemb.ly/WebDev-Connected-Classroom/Testing-Mocha-Chai)
* HW  - CHECK OUT THE REACT DOCS

#### __Friday__ - Intro To React
* Links 
